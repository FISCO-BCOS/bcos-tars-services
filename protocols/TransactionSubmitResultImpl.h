...
public:
  ...
  TransactionSubmitResultImpl(bcos::crypto::CryptoSuite::Ptr cryptoSuite)
      : bcos::protocol::TransactionSubmitResult(), m_inner(std::make_shared<bcostars::TransactionSubmitResult>()), m_cryptoSuite(cryptoSuite) {}

  TransactionSubmitResultImpl(bcostars::TransactionSubmitResult *result, bcos::crypto::CryptoSuite::Ptr cryptoSuite)
      : bcos::protocol::TransactionSubmitResult(),
        m_inner(std::shared_ptr<bcostars::TransactionSubmitResult>(result, [](bcostars::TransactionSubmitResult *) {})), m_cryptoSuite(cryptoSuite) {}
